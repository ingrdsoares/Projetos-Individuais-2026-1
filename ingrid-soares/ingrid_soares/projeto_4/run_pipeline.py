...
from ingrid_soares.projeto_4.src.core.ingestion import IngestionPipeline
from ingrid_soares.projeto_4.src.core.processor import UDAProcessor
from ingrid_soares.projeto_4.src.database.database import init_db, get_db_connection
